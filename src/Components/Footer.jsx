...
const Footer = memo(() => {
    return (
        <footer className={style.footer}>
            ...
            <Socials styleModule={style}></Socials>
...
export function Socials({ styleModule }) {
    return (
        <div className={styleModule.socials}>
            <div className={styleModule.circle} onClick={pullOutComingSoon} >
    ...
    return (
        <div className={style.footerLinks}>
            <div className={style.up}>
                ...
                <Link onClick={pullOutComingSoon}>FAQs</Link>
                <Link onClick={pullOutComingSoon}>Covid-19 Policy</Link>
            </div>
            ...
            <div className={style.container}>
                ...
                <form action="" onSubmit={(e) => e.preventDefault()} className={style.form}>
                    ...
                    <div className={style.agreement}>
                        ...
                        <button type="" onClick={pullOutComingSoon}>Submit</button>
                    </div>
                </form>
            </div>
        </div>
